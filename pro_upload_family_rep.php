...
$response = array(
			...
			break;
			          ...
			          $upload_address=$upload->upload_csv_existing_family_rep($data[$i][0],$data[$i][1],$dob,$data[$i][3],$data[$i][4],$data[$i][5],$data[$i][6],$data[$i][7],$data[$i][8],$data[$i][9],$data[$i][10],$data[$i][11],$data[$i][12],$dob_year,'1',$data[$i][13],$connect);
